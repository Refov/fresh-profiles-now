...
// Diagnostics (safe): check if env vars are present
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['ping'])) {
  $hasUrl = (bool) (getenv('SB_URL') ?: (getenv('SUPABASE_URL') ?: getenv('REFOV_SUPABASE_URL')));
  $hasKey = (bool) (getenv('SR_KEY') ?: (getenv('SUPABASE_SERVICE_ROLE_KEY') ?: getenv('REFOV_SUPABASE_SERVICE_ROLE_KEY')));
...
// Fetch candidate email from Supabase REST (env only)
$supabaseUrl = getenv('SB_URL') ?: (getenv('SUPABASE_URL') ?: getenv('REFOV_SUPABASE_URL'));
$serviceKey = getenv('SR_KEY') ?: (getenv('SUPABASE_SERVICE_ROLE_KEY') ?: getenv('REFOV_SUPABASE_SERVICE_ROLE_KEY'));
